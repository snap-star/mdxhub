    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="flex flex-col items-center text-center max-w-lg">
          ...
          <div className="mt-10">
            <p className="text-xs text-muted-foreground mb-3">Or try searching for what you need</p>
            <button
            ...
            >
              Search… <kbd className="text-[0.6rem] bg-background px-1.5 py-0.5 rounded font-mono border border-border">⌘K</kbd>
            </button>
          </div>
        </div>
      </main>
